...
import com.infinova.sso.service.SSORedisService;
...
public class RedisServiceTest {
	...
	private Logger logger = LoggerFactory.getLogger(SSORedisService.class);

	@Autowired
	private SSORedisService redisService;
	@Autowired
